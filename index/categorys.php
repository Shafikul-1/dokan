...
<div class="">
    ...
    ?>
            <div class="flex justify-between my-4">
                ...
                <a href="<?php echo $databaseFN->mainUrl . "/product?categoryid=" . $result[$i]['id'] . "&name=" . $result[$i]['categoryName'] ?>" class="capitalize hover:underline hover:underline-offset-4 ">Al <?php echo $result[$i]['categoryName'] ?> Product <i class="fa-solid fa-arrow-right-long"></i></a>
            </div>
