    ...
    <div class="bg-white py-4 md:py-4 px-4 md:px-4 xl:px-5 dark:bg-gray-800">
        ...
        <div class="mt-7 overflow-x-auto">
            <table class="w-full whitespace-nowrap">
                <tbody>
                    <?php
                    if ($databaseFN->getData("productdetails", "productdetails.id, productdetails.releaseDate, productdetails.productName, users.name, productcatagory.categoryName", null, null, " id DESC", "5", " productcatagory ON productdetails.category = productcatagory.id LEFT JOIN users ON productdetails.userAuth = users.userRoll")) {
                            ...
                            <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded relative">
                                ...
                                <td class="">
                                    <div class="flex items-center pl-5">
                                        <p class="text-base font-medium leading-none text-gray-700 mr-2"><?php echo substr(html_entity_decode($productName), 0, 25); ?> ...</p>
                                ...
                                <td class="pl-4">
                                    <p class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none"> <?php echo html_entity_decode($categoryName); ?> </p>
                                </td>
                                <td class="pl-24">
