...
<div class="container ">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="https://github.com/fajar7xx/ecommerce-template-tailwind-1/blob/main/public/assets/images/products/product8.jpg?raw=true" alt="product 1" class="w-full">
...
<!-- banner -->
<div class="bg-cover bg-no-repeat bg-center py-36" style="background-image: url('https://raw.githubusercontent.com/fajar7xx/ecommerce-template-tailwind-1/main/public/assets/images/banner-bg.jpg');">
    <div class="container">
...
<div class="container pb-16">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="https://github.com/fajar7xx/ecommerce-template-tailwind-1/blob/main/public/assets/images/products/product1.jpg?raw=true" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition" title="view product">
                        <i class="fa-solid fa-magnifying-glass"></i>
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="https://github.com/fajar7xx/ecommerce-template-tailwind-1/blob/main/public/assets/images/products/product2.jpg?raw=true" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition" title="view product">
                        <i class="fa-solid fa-magnifying-glass"></i>
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="https://github.com/fajar7xx/ecommerce-template-tailwind-1/blob/main/public/assets/images/products/product6.jpg?raw=true" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition" title="view product">
                        <i class="fa-solid fa-magnifying-glass"></i>
        ...
        <div class="bg-white shadow rounded overflow-hidden group">
            <div class="relative">
                <img src="https://github.com/fajar7xx/ecommerce-template-tailwind-1/blob/main/public/assets/images/products/product9.jpg?raw=true" alt="product 1" class="w-full">
                <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                    justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
                    <a href="#" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition" title="view product">
                        <i class="fa-solid fa-magnifying-glass"></i>
