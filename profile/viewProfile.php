...
?>
      <div class="bg-white md:mx-auto rounded shadow-xl w-full md:w-1/2 overflow-hidden">
        ...
        <div class="px-5 py-2 flex flex-col gap-3 pb-6">
          <div class="h-[90px] shadow-md w-[90px] rounded-full border-4 overflow-hidden -mt-14 border-white"><img src="../upload/<?php echo ($img == null) ? 'user/user-defult-icon.png' : $img ?>" alt="<?php echo ($img == null) ? 'user-defult-icon.png' : $img ?>" class="w-full h-full rounded-full object-center object-cover"></div>
          <div class="">
